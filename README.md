...
|[RC](https://sigarra.up.pt/feup/en/UCURR_GERAL.FICHA_UC_VIEW?pv_ocorrencia_id=520330)|[Trabalho Prático 1<br>_Practical Assignment 1_](https://github.com/pedroojanuu/rc_tp1)|Protocolo de transmissão de ficheiro entre duas máquinas via porta-série (protocolo de camada de ligação de dados).<br>_File transfer between two machines via serial port (data link layer protocol)._|C|17.5|
